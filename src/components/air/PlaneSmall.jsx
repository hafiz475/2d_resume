...
export default function PlaneSmall() {
  const ref = useRef();
  usePlaneAnimation(ref, "A");  // Fast zip across sky

  return (
    <g ref={ref} style={{ cursor: "pointer" }} onClick={showSkyStory}>  // ← Sky story
      <svg
        height="64px"
        width="64px"
      ...
      >
        {/* Your full small plane SVG paths here — unchanged */}
